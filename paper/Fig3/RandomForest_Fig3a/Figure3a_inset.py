...
fi = pd.DataFrame({'feature': top_features, 'importance': top_feature_importances})
fi[fi['feature']<37].to_csv('calculated_feature_importance.csv', index=False)
