...
df_struct_type_counts.to_csv('CSP_results.csv', index=False)

# Bar plot of the results

sns.set(context="paper", font_scale=3)
sns.set_style(style='white')
ax = df_struct_type_counts.plot.bar(figsize=(11,11), rot=0)
ax.set_ylabel("Number of structures")
ax.set_xlabel("Structure type")
#ax.set_title("Structure types of predicted structures")
#plt.savefig("structure_types.pdf", dpi=600, bbox_inches="tight")
plt.show()
