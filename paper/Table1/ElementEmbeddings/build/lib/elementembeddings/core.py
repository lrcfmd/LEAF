...
class Embedding:
    ...
    def load_data(embedding_name: Optional[str] = None):
        ...
        """
        _cbfv_files = {
            "leaf_neighbour": "LEAF_NEIGH.csv",
            "leaf200": "leaf200.csv",
            "leaf59": "LEAF59.csv",
            "leaf200magpie": "leaf200magpie.csv",
            "leaf2_200": "LEAF_2_200.csv",
            "leaf_average": "LEAF_average.csv",
            "leaf_av_magpie": "leaf_av_magpie.csv",
            "magpie": "magpie.csv",
            "magpie_sc": "magpie_sc.json",
            "mat2vec": "mat2vec.csv",
            "magpie_mat2vec":"magpie_mat2vec.csv",
